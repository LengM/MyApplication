package com.yng.ming.myapplication.widget.swipe;
...
import static com.yng.ming.myapplication.widget.swipe.State.CLOSE;

/**
 * Created by guanaj on 2017/6/5.
 * 简单的侧滑功能 https://github.com/anzaizai/EasySwipeMenuLayout
 */
