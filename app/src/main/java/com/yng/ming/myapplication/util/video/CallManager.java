...
import com.yng.ming.myapplication.ui.video.VideoCallActivity;
...
//        initBluetoothListener();
    ...
    public void saveCallMessage() {
        Logcat.e("The call ends and the call log message is saved! " + endType);
...
//                content = String.valueOf(getCallTime());
                break;
            case CANCEL: // 取消
                saveMsg = context.getString(R.string.call_cancel);
//                content = context.getString(R.string.call_cancel);
            ...
            case OFFLINE: // 对方不在线
                ...
                break;
            case REJECT: // 拒绝的
                saveMsg = context.getString(R.string.call_reject_is_incoming);
//                content = context.getString(R.string.call_reject_is_incoming);
        ...
        body = new EMTextMessageBody(saveMsg);
...
//        saveCallMessage();
    ...
    public void endCall() {
        try {
            ...
            e.printStackTrace();
            Logcat.e("结束通话失败：error %d - %s" + e.getErrorCode() + e.getMessage());
        }
        // 挂断电话调用保存消息方法
//        saveCallMessage();
        // 通话结束，重置通话状态
     ...
     * 2、MODE_IN_CALL：
     * 3、MODE_IN_COMMUNICATION：这个和 CALL 都表示通讯模式，不过 CALL 在华为上不好使，故使用
     * COMMUNICATION
        ...
        if (isLoaded) {
            ...
            soundPool.setOnLoadCompleteListener(new SoundPool.OnLoadCompleteListener() {
                ...
                public void onLoadComplete(SoundPool soundPool, int i, int i1) {
                    Logcat.i("SoundPool load complete! loadId: %d" + loadId);
                    isLoaded = true;
                    // 首次监听到加载完毕，开始播放音频
                    playCallSound();
                }
